export const tr = {
  ...
  admin: {
    ...
    angle: {
      modalTitle: 'Açı Ekle',
      stepDirection: 'Önce hangi yöne bakacağını seç.',
      stepImage: 'Şimdi bu açıda görünecek görseli seç.',
      left: 'Sola Bak',
      right: 'Sağa Bak',
      alreadyTaken: 'Bu yönde zaten bir açı var.',
      backToDirection: 'Yön seçimine dön',
      confirm: 'Açıyı Ekle',
      lookLeft: 'Sola bak',
      lookRight: 'Sağa bak',
    ...
    notes: {
      title: 'Dünya Notları',
      subtitle: 'Bu dünya için yapılacakları ve aklında kalanları buraya yaz.',
      empty: 'Henüz not yok. İlk notunu yukarıdan ekleyebilirsin.',
      titleLabel: 'Not Başlığı',
      titlePlaceholder: 'örn. Mutfak sahnesine gece açısı ekle',
      bodyLabel: 'Detay',
      bodyPlaceholder: 'İstersen birkaç satır detay ekle…',
      addButton: 'Not Ekle',
      adding: 'Ekleniyor…',
      saveButton: 'Kaydet',
      saving: 'Kaydediliyor…',
      ...
      markOpen: 'Tekrar aç',
      openHeading: 'Yapılacaklar',
      doneHeading: 'Tamamlananlar',
      counter: '{done} / {total} tamamlandı',
      updatedAt: 'Güncellendi',
      loadError: 'Notlar yüklenemedi. Sunucu bağlantısını kontrol edin.',
      saveError: 'Not kaydedilemedi. Lütfen tekrar deneyin.',
      deleteError: 'Not silinemedi. Lütfen tekrar deneyin.',
      deleteTitle: 'Notu Sil',
      deleteQuestion: '"{name}" notunu kalıcı olarak silmek üzeresin.',
      deleteIrreversible: 'Bu işlem geri alınamaz.',
      deleteConfirm: 'Kalıcı Olarak Sil',
      deleting: 'Siliniyor…',
    },
